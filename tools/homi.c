...
/**
 * Where clients of a given shm_id find the server
 *
 ...
 * client is an ordinary case. /tmp for the same reason the role lock is
 ...
 * difference between a server that exists and one that can be attached to.
 */
static int
